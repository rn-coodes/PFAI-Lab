  ...
  return (
    <main className="mx-auto max-w-[1480px] border-x border-black/15 dark:border-white/15">
      <header className="grid border-b border-black/20 dark:border-white/20 lg:grid-cols-[1fr_0.55fr]">
        <div className="min-w-0 border-b border-black/15 p-6 dark:border-white/15 sm:p-12 lg:border-b-0 lg:border-r">
        ...
        <div className="min-w-0 p-6 sm:p-12 lg:flex lg:items-end"><p className="max-w-md break-words text-base leading-8 text-slate-600 dark:text-slate-300">Production-minded Go builds presented as inspectable system records. Open a case study, run the live interface, or review the source.</p></div>
      </header>
      <ProjectGrid />
    </main>
  );
