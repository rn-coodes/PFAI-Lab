      ...
      <motion.div className="relative mx-auto max-w-7xl overflow-hidden rounded-lg bg-slate-950 text-white" initial={{ opacity: 0, y: 35 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
        ...
        <div className="relative grid gap-8 p-7 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-end lg:pr-80">
          ...
          <div className="flex gap-3">
            ...
            <motion.div whileHover={{ y: -5 }}><Link href="mailto:rehanmalik42011@gmail.com" className="premium-button flex h-12 items-center gap-3 rounded-md bg-lime-300 px-5 text-xs font-black uppercase text-slate-950 transition hover:bg-white"><Mail className="h-4 w-4" /> Let&apos;s talk <ArrowUpRight className="h-4 w-4" /></Link></motion.div>
          </div>
        </div>
